package com.nixtap.nfcservice.entity;
...
public class NfcTag {
    ...
    /** Hardware UID read from the physical NFC chip — globally unique. */
    ...
    /** URL currently written to the NFC tag — e.g. https://nixtap.com/card/{slug} */
    @Column(name = "linked_url", length = 500)
    private String linkedUrl;

    /** User-defined label for this tag, e.g. "Black Metal Card", "Sticker v2". */

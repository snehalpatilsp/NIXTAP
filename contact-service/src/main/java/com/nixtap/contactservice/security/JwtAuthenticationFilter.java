package com.nixtap.contactservice.security;

import com.nixtap.contactservice.config.JwtUtil;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        } catch (Exception e) { logger.error("Cannot set user authentication: " + e.getMessage(), e); }

...
import com.nixtap.qrservice.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleQrGeneration(
        ...
        log.error("QR generation failed at {}: {}", request.getServletPath(), ex.getMessage(), ex);
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
    ...
    @ExceptionHandler(QrAccessDeniedException.class)
    public ResponseEntity<ErrorResponse> handleAccessDenied(
            QrAccessDeniedException ex, HttpServletRequest request) {
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
                .status(HttpStatus.FORBIDDEN.value())
                .message(ex.getMessage())
                .path(request.getServletPath())
                .errorCode("QR_ACCESS_DENIED")
                .build();

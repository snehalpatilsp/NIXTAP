...
import com.nixtap.meetingservice.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(ResourceNotFoundException ex, HttpServletRequest req) {
        return build(HttpStatus.NOT_FOUND, ex.getMessage(), "MEETING_NOT_FOUND", req);
    }

    @ExceptionHandler(MeetingAccessDeniedException.class)
    public ResponseEntity<ErrorResponse> handleAccessDenied(MeetingAccessDeniedException ex, HttpServletRequest req) {
        return build(HttpStatus.FORBIDDEN, ex.getMessage(), "MEETING_ACCESS_DENIED", req);
    }

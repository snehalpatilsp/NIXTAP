...
import com.nixtap.notificationservice.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccessDenied(NotificationAccessDeniedException ex, HttpServletRequest req) {

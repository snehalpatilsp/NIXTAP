package com.nixtap.socialservice.entity;
...
public class SocialLink {
    ...
    /** Optional: link scoped to a specific card. Null means it appears on all cards. */
    @Column(name = "card_id")
    private Long cardId;
    ...
    /** Label shown on the card (e.g. "@dhananjay" or "LinkedIn Profile"). */
    @Column(name = "display_label", length = 100)
    private String displayLabel;

    /** CSS icon class or icon name for frontend rendering. */
    ...
    /** Lower number = shown first on the card. */
